...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4 mt-2">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('siswa.update', $siswas->id) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label for="name_create">Name:</label>
                        <input type="" value="{{ $siswas->name }}" name="name" id="name_create"
                    ...
                    <div class="form-group">
                        ...
                        <input type="" value="{{ $siswas->nisn }}" name="nisn" id="nisn_create"
                    ...
                    <div class="form-group">
                        ...
                        <input type="" value="{{ $siswas->nis }}" name="nis" id="nis_create"
                    ...
                    <div class="form-group">
                        ...
                        <input type="" value="{{ $siswas->user->email }}" name="email" id="email_create"
                    ...
                    <div class="form-group">
                        ...
                        <input type="" value="{{ $siswas->alamat }}" name="alamat" id="alamat_create"
                    ...
                    <div class="form-group">
                        ...
                        <input type="" value="{{ $siswas->no_telp }}" name="no_telp" id="no_telp_create"
